...
int main( int argc, char** argv ) {
    ...
    // Load Sources
    templMat = imread("FILE.DATA"); // PICTURE OF OBJECT YOU WANT TO TRACK
    VideoCapture cap("FILE.DATA"); // VIDEO IN WHICH THE OBJECT MOVES
    ...
    while (1) {
        ...
        if (imgMat.empty() || templMat.empty()) {
            cout << "Are you sure your files are in the right directory?" << endl;
            break;
        }
